...
def main():
    ...
    ctrl = IMUController()
    threshold  = 0.35
    ctrl.register_trigger(moveplayer, {'dira' : 4 }, ctrl.mov_x, threshold, ThresholdType.HIGHER)
    ...
    ctrl.register_trigger(moveplayer, {'dira' : 3 }, ctrl.mov_y, -threshold, ThresholdType.LOWER)
