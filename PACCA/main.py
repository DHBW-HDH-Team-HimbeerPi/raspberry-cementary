...
def main():
    ...
    ctrl.register_trigger(moveplayer, {'dira' : 0 }, ctrl.mov_y, threshold, ThresholdType.HIGHER)
    ctrl.register_trigger(moveplayer, {'dira' : 0 }, ctrl.mov_y, -threshold, ThresholdType.LOWER)
