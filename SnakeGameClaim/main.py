...
def main():
    ...
    try:
        ...
        controller.register_trigger(inputToDirection, {'direc' : 3}, controller.mov_x, rotationTreshold, ThresholdType.HIGHER)
        controller.register_trigger(inputToDirection, {'direc' : 4}, controller.mov_x, -rotationTreshold, ThresholdType.LOWER)
